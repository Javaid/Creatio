...
module.exports = (sequelize, DataTypes) => {
  const JiraPriority = sequelize.define(
    'JiraPriority',
    {
      ...uuidPk(DataTypes),
    ...
    {
      tableName: 'jira_priorities',
      underscored: true,
    }
  );

  JiraPriority.associate = (models) => {
    JiraPriority.hasMany(models.JiraIssue, { foreignKey: 'priorityId', as: 'issues' });
  };
